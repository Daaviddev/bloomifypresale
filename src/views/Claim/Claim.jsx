...
function Claim() {
  ...
  console.log("-------->", totalPurchasedAmount)
      ...
      <Paper className={`ohm-card`}>
        ...
        {/* <Grid item>
          <div className="stake-top-metrics" style={{marginBottom: "18px"}}>
            ...
            <Typography className="presale-items">So after the Presale <span className="spant">20%</span>.</Typography>
          </div>
        </Grid> */}
        {totalPurchasedAmount && 
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              ...
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span className="spant">{totalPurchasedAmount} $</span></Typography>
            </div>
          </Grid>
        }
        {claimedAmount && 
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              ...
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span className="spant">{claimedAmount} $pNCTR</span></Typography>
            </div>
          </Grid>
        }
        {claimableAmount && 
          <Grid item>
            <div className="stake-top-metrics data-row-centered" style={{marginBottom: "18px"}}>
              ...
              <Typography className="presale-items" style={{marginLeft: "16px"}}><span className="spant">{claimableAmount} $pNCTR</span></Typography>
            </div>
          </Grid>
        }
        <Grid item>
                ...
                !hasAllowance("pbhd") ? (
                  <Box className="help-text">
                    <Typography variant="body1" className="stake-note" color="textSecondary">
                      <>
                        First time use <b>$pNCTR</b>?
                        <br />
                        Please approve NCTR to use your <b>$pNCTR</b> for claim $pNCTR.
                      </>
                    </Typography>
                  </Box>
                ) : (
